  ...
  return (
    <div className={props.className}>
      ...
      <div className="flex-grow relative rounded-xl shadow-sm">
        <textarea
          className="block appearance-none h-full w-full bg-white border border-gray-200 transition hover:border-gray-500 px-3 py-2 rounded-xl leading-tight focus focus:border-yellow-400"
          name={props.id}
          id={props.id}
